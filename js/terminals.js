...
const base = `olivia@<span style="color: lightgreen">myouri</span>:<span style="color: dodgerblue">~</span>$ `;
let array = [];
let input = "";
let lastIdx = -1;
let lastCmd = "";
...
function inputLine(text) {
    terminal.innerHTML += `\n<div class=\"new-line\">olivia@<span style=\"color: lightgreen\">myouri</span>:<span style=\"color: dodgerblue\">~</span>$ ${text ? text : ''}</div>`;
}
